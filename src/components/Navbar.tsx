...
const Navbar = async () => {
  ...
  return (
    <div className="z-50 mx-auto w-full max-w-screen-xl border-2 border-secondary bg-primary-foreground md:sticky md:top-0 md:rounded-b-lg lg:max-w-screen-2xl">
      <Section
        as="header"
        width="xl"
