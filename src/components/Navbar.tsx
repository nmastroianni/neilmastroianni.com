...
const Navbar = async () => {
  ...
  return (
    <div className="border-secondary z-50 mx-auto w-full max-w-(--breakpoint-xl) border-2 bg-slate-900 md:sticky md:top-0 md:rounded-b-lg lg:max-w-(--breakpoint-2xl)">
      <Section
        as="header"
        width="xl"
